#!/bin/bash
# agentworld-q8-server.sh — Qwen-AgentWorld-35B-A3B Q8_0 runner (unsloth quant)
#
# Q8_0 quantization: ~37 GB. Near-BF16 quality, half disk usage.
# Same fast MoE performance as Q4 (~80-95 tok/s on Metal).
...
MODEL="${MODEL_DIR}/Qwen-AgentWorld-35B-A3B-Q8_0.gguf"
PORT="${PORT:-8084}"
HOST="${HOST:-0.0.0.0}"
...
# === Print config ===
echo "=== Qwen-AgentWorld-35B-A3B MoE Runner (Q8_0) ==="
echo "model:  $MODEL"
echo "port:   $PORT"
