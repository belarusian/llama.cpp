#!/bin/bash
# qwen36-server.sh — Qwen3.6 model runner
#
...
#
# Model Note:
#   The recommended model is Qwen3.6-35B-A3B (MoE). It gives the best quality-
#   per-token ratio we can run on this hardware. MTP speculative decoding was
#   tested but doesn't work well on Apple Silicon — negligible throughput gain
#   compared to running the 35B-A3B MoE variant directly with no speculation.
...
MMPROJ="${MODEL_DIR}/vision/mmproj-qwen3.6-35b.gguf"
